...
public class ApiOrderGeneratePartitionJobConfiguration {
    ...
    @StepScope
    @Bean
    public FlatFileItemWriter<ApiOrder> apiOrderGenerateWriter(@Value("#{stepExecutionContext['targetDate']}") String targetDate) {
